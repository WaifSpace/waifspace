...
class AIService {
  ...
  // 翻译默认使用 3.5, 能更节省钱
  Future<String> translate(String text, {String model = 'gpt-3.5-turbo'}) async {
    if(text.isEmpty) {
      return '';
    }
