        ...
        children: [
          ...
          Expanded(
            child: Obx(() {
              return ListView(
                padding: const EdgeInsets.fromLTRB(0, 0, 0, 0),
                children: ArticleSourceProvider.to.cacheArticleSources.map((articleSource) {
                  return Slidable(
                    startActionPane: ActionPane(
                      motion: const ScrollMotion(),
                      ...
                      children: [
                        SlidableAction(
                          onPressed: (context) => { controller.removeSource(articleSource.id) },
                        ...
                        SlidableAction(
                          onPressed: (context) => { controller.makeSourceRead(articleSource.id) },
                          backgroundColor: const Color(0xFF21B7CA),
                          foregroundColor: Colors.white,
                          icon: Icons.mark_chat_read,
                          label: '已读',
                    ...
                    child: ListTile(
                      ...
                      title: Row(
                        ...
                        children: [
                          ...
                          Obx(() => Text(controller.articleSourceCountInfo[articleSource.id!] ?? '0/0')),
                        ],
                      ),
                      onTap: () => controller.showArticlesFromSource(articleSource),
